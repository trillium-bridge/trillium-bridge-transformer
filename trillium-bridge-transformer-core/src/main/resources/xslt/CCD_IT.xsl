               ...
               <xsl:for-each select="n1:author/n1:assignedAuthor">
                  ...
                  <xsl:if test="n1:addr | n1:telecom">
                     <tr>
                        <td bgcolor="#3399ff">
                           <span class="td_label">
                              <xsl:text>Informazione Contatto</xsl:text>
                           </span>
                        </td>
                        <td>
         ...
         <table class="header_table">
            <tbody>
               <tr>
                  <td width="20%" bgcolor="#3399ff">
                     <span class="td_label">
                        <xsl:text>Documento conservato da</xsl:text>
                     </span>
                  </td>
                  <td width="80%">
                     <xsl:choose>
            ...
            <xsl:for-each select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole">
               <xsl:if test="not(n1:id/@nullFlavor)">
                  ...
                  <tr>
                     ...
                     <td bgcolor="#3399ff">
                        <span class="td_label">
                           <xsl:text>IDs del Paziente</xsl:text>
                        </span>
                     </td>
                     <td>
                        <xsl:for-each select="n1:id">
   ...
   <xsl:template name="translateRoleAssoCode">
      ...
      <xsl:choose>
         ...
         <xsl:when test="$classCode='PRS'">
            <xsl:text>Relazioni personali</xsl:text>
         </xsl:when>
